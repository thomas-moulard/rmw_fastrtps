...
rmw_get_subscriber_names_and_types_by_node(
    ...
    return rmw_fastrtps_shared_cpp::__rmw_get_subscriber_names_and_types_by_node(
            eprosima_fastrtps_identifier, node, allocator, node_name, node_namespace, no_demangle, topic_names_and_types);
}
...
rmw_get_service_names_and_types_by_node(
    ...
    return rmw_fastrtps_shared_cpp::__rmw_get_service_names_and_types_by_node(
            eprosima_fastrtps_identifier, node, allocator, node_name, node_namespace, service_names_and_types);
}
