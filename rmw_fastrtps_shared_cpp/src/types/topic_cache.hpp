...
public:
     ...
     */
    bool addTopic(const eprosima::fastrtps::rtps::InstanceHandle_t &rtpsParticipantKey,
     ...
     * @return true if a change has been recorded
     */
    bool removeTopic(const eprosima::fastrtps::rtps::InstanceHandle_t &rtpsParticipantKey,
                     const std::string &topic_name,
                     const std::string &type_name) {
